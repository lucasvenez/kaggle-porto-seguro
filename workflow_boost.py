...
train = train.merge(pd.read_csv('./output/ft_distance_vars_train.csv'), how='inner', on='id')
train = train.merge(pd.read_csv('./output/ft_kinetic_train.csv'), how='inner', on='id')

test = test.merge(pd.read_csv('./output/ft_distance_vars_test.csv'), how='inner', on='id')
test = test.merge(pd.read_csv('./output/ft_kinetic_test.csv'), how='inner', on='id')
